...
- Treat the cleaned `assets/nailong-identity-01.png`, `assets/nailong-identity-02.png`, and `assets/nailong-identity-03.png` as the highest-priority Nailong identity, body-shape, material, and limb-proportion references. Use all three before relying on the written description: 01 anchors the neutral frontal silhouette and long-limb reach, 02 anchors three-quarter belly projection and relaxed arm scale, and 03 anchors wide action poses, bent-leg support, and functional hand contact. Match their belly dominance, continuous anatomy, warm yellow-to-orange surface, cream belly patch, embedded green eyes, small mouth, and brown-gray extremities.
